                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex gap-2">
                                    <button
                                        ...
                                        className={`flex-1 py-3 px-4 rounded-xl border text-[9px] font-black uppercase tracking-wider transition-all flex items-center justify-center gap-1.5 ${
                                            catTargetDepartments.length === 1 && catTargetDepartments.includes('kitchen')
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex gap-2">
                                    <button
                                        type="button"
                                        onClick={() => {
                                            setStkTargetDepartments(prev => 
                                                prev.includes('kitchen') ? prev.filter(d => d !== 'kitchen') : [...prev, 'kitchen']
                                            );
                                        }}
                                        className={`flex-1 py-3 px-4 rounded-xl border text-[9px] font-black uppercase tracking-wider transition-all flex items-center justify-center gap-1.5 ${
                                    ...
                                    <button
                                        ...
                                        onClick={() => {
                                            setStkTargetDepartments(prev => 
                                                prev.includes('bartender') ? prev.filter(d => d !== 'bartender') : [...prev, 'bartender']
                                            );
                                        }}
                                        className={`flex-1 py-3 px-4 rounded-xl border text-[9px] font-black uppercase tracking-wider transition-all flex items-center justify-center gap-1.5 ${
