                    ...
                    <form onSubmit={handleSubmit} className="p-5 space-y-4">
                        ...
                        <div>
                            <input 
                                ...
                                className="w-full bg-slate-900 border border-white/10 rounded-xl px-4 py-2 text-sm text-white focus:border-orange-500"
                            />
                        </div>
                        ...
                        <div>
                            <textarea 
                                ...
                                className="w-full bg-slate-900 border border-white/10 rounded-xl px-4 py-2 text-sm text-white focus:border-orange-500 resize-none"
                            ></textarea>
                        </div>
                        ...
                        <button 
                            type="submit"
                            disabled={isSending}
                            className="w-full bg-orange-500 hover:bg-orange-600 text-white font-black uppercase text-xs tracking-widest py-3 rounded-xl transition-all flex items-center justify-center gap-2"
                        >
