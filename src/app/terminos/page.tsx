...
export default function TerminosPage() {
  return (
    <div className="min-h-screen bg-slate-950 text-slate-300 p-6 sm:p-12 selection:bg-orange-500/30">
      <div className="max-w-4xl mx-auto bg-slate-900/50 p-8 sm:p-12 rounded-[2.5rem] border border-white/5 shadow-2xl relative">
        ...
        <div className="flex flex-col items-center mb-10 mt-8">
          <div className="w-16 h-16 bg-orange-500/10 flex items-center justify-center rounded-2xl mb-4 border border-orange-500/20">
          ...
          <p className="text-orange-500 font-bold tracking-widest uppercase text-xs mt-2">mmmTodoLoQueQuiero SaaS</p>
          <p className="text-slate-500 text-xs mt-2">Última actualización: {new Date().toLocaleDateString('es-AR')}</p>
        </div>

        <div className="space-y-8 text-sm sm:text-base leading-relaxed">
          <section>
            <h2 className="text-xl font-bold text-white mb-3 flex items-center gap-2"><span className="text-orange-500">1.</span> Aceptación de los Términos</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3 flex items-center gap-2"><span className="text-orange-500">2.</span> Descripción del Servicio</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3 flex items-center gap-2"><span className="text-orange-500">3.</span> Cuentas y Responsabilidades del Local</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3 flex items-center gap-2"><span className="text-orange-500">4.</span> Integraciones y Pasarelas de Pago</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3 flex items-center gap-2"><span className="text-orange-500">5.</span> Planes, Suscripciones y Pagos</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3 flex items-center gap-2"><span className="text-orange-500">6.</span> Propiedad Intelectual</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3 flex items-center gap-2"><span className="text-orange-500">7.</span> Limitación de Responsabilidad</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3 flex items-center gap-2"><span className="text-orange-500">8.</span> Modificaciones a los Términos</h2>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 text-center">
          ...
          <Link href="/">
            <button className="mt-6 px-8 py-3 bg-slate-800 hover:bg-orange-500 text-white font-bold rounded-xl transition-colors">
              Volver al inicio
            </button>
          </Link>
        </div>
